...
const Projects = () => {
    ...
    const projectList = [
        ...
        {
            photo: projectPhoto2,
            text: 'Відеокурс із надання першої духовно-психологічної допомоги. Призначене для молоді та членів церков, які хочуть навчитися надавати першу психологічну допомогу собі та ближнім у кризових ситуаціях.',
            href: 'https://onovlennia.com.ua/courses/menachem/',
            isButton: true,
            isSocialLinks: false,
            telegramHref: null,
            instagramHref: null,
        ...
        {
            photo: projectPhoto3,
            text: '110 прямих ефірів про те, що болить, і про Того, хто допомагає проходити цей біль.',
